...
- The running fixed-sticker release is unchanged. The image-edit feature will be staged and tested on Linux before live activation; see [setup and runtime behavior](image-stickers.md).
